                        ...
                        <div class="p-6 -mt-16 text-center">
                            ...
                            <div class="mt-6 space-y-2 text-left">
                                <div class="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    ...
                                    <span>jane.perlas@example.com</span>
                                </div>
                                <div class="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <svg class="w-5 h-5 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
                        ...
                        <ol class="relative border-l-2 border-indigo-200 dark:border-gray-700 ml-3 space-y-6">
                            <li class="ml-6">
                                ...
                                <p class="text-indigo-600 dark:text-indigo-400 font-medium">University of the Philippines</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">2018 – 2022</p>
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Graduated with honors. Specialized in web development, databases, and software engineering.</p>
                            </li>
                            <li class="ml-6">
                                <span class="absolute flex items-center justify-center w-6 h-6 rounded-full bg-indigo-100 dark:bg-indigo-900 ring-4 ring-white dark:ring-gray-800 -left-3">
                                    <svg class="w-3 h-3 text-indigo-600 dark:text-indigo-300" fill="currentColor" viewBox="0 0 20 20"><path d="M10 18a8 8 0 100-16 8 8 0 000 16z"/></svg>
                                </span>
                                <h4 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Senior High School (STEM)</h4>
                                <p class="text-indigo-600 dark:text-indigo-400 font-medium">Philippine Science High School</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">2016 – 2018</p>
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Focused on science, technology, engineering, and mathematics track.</p>
                            </li>
                        </ol>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl p-5 hover:shadow-lg transition-shadow">
                                <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Task Manager App</h4>
                                ...
                                <a href="https://github.com/janeperlas/task-manager" target="_blank" class="inline-flex items-center gap-2 text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800">
                            ...
                            <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl p-5 hover:shadow-lg transition-shadow">
                                <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">E-Commerce Store</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Responsive online store with product catalog, cart, and checkout workflow built with Vue.js and a Laravel API backend.</p>
                                <a href="https://github.com/janeperlas/ecommerce" target="_blank" class="inline-flex items-center gap-2 text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/>
                                    </svg>
                                    View on GitHub
                            ...
                            <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl p-5 hover:shadow-lg transition-shadow">
                                <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Blog Platform</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Minimal blog CMS with markdown support, tags, and search, developed with Laravel and Tailwind CSS.</p>
                                <a href="https://github.com/janeperlas/blog-platform" target="_blank" class="inline-flex items-center gap-2 text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/>
                                    </svg>
                                    View on GitHub
